...
* Keep changelog entries concise, following the format and level of detail of the existing
  entries: one bullet per change, starting with the issue or pull request
