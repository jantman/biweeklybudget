...
Shows a pay period (current in this example) balances (income, allocated, spent, remaining), per-account transaction totals for that period, budgets and transactions (previous/manually-entered and scheduled).
