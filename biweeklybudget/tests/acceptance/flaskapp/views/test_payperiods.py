...
class TestPayPeriodOtherPeriodInfo(AcceptanceHelper):
    ...
    def test_3_add_transactions(self, testdb):
        ...
        t15 = Transaction(
            date=(ppdate + timedelta(days=3)),
            budget_amounts={e1budget: Decimal('550.00')},
...
class TestCurrentPayPeriod(AcceptanceHelper):
    ...
    def test_01_add_transactions(self, testdb):
        ...
        t = Transaction(
            ...
            budget_amounts={e1budget: Decimal('12.00')},
        ...
        t2 = Transaction(
            date=(ppdate + timedelta(days=6)),
            budget_amounts={e1budget: Decimal('111.13')},
        ...
        t3 = Transaction(
            date=(ppdate + timedelta(days=2)),
            budget_amounts={testdb.query(Budget).get(4): Decimal('-333.33')},
    ...
    def test_07_transaction_table(self, base_url, selenium, testdb):
        ...
        assert htmls == self.sort_trans_rows([
            ...
            [
                ...
                '$232.22',
                '<a href="javascript:transModal(8, null);">T3 (8)</a>',
            ...
            [
                ...
                '-$333.33',
                '<a href="javascript:transModal(7, null);">T2 (7)</a>',
            ...
            [
                ...
                '$111.13',
                '<a href="javascript:transModal(6, null);">T1foo (6)</a>',
                '<a href="/accounts/1">BankOne</a>',
                '<a href="/budgets/1">Periodic1</a>',
            ...
            [
                ...
                '$12.00',
                '<a href="javascript:transModal(5, null);">Txn From ST7'
                ' (5)</a>',
                '<a href="/accounts/1">BankOne</a>',
                '<a href="/budgets/1">Periodic1</a>',
    ...
    def test_30_issue152_inactive_budget(self, testdb):
        ...
        testdb.add(trans)
        testdb.commit()
        t1 = testdb.query(Transaction).get(10)
...
class TestMakeTransModal(AcceptanceHelper):
    ...
    def test_05_modal_schedtrans_to_trans(self, base_url, selenium, testdb):
        ...
        assert texts[1][2] == 'ST7 per_period Trans (7)'
    ...
    def test_16_transaction_table(self, base_url, selenium, testdb):
        ...
        assert htmls == self.sort_trans_rows([
            ...
            [
                dtnow().date().strftime('%Y-%m-%d'),
                '-$123.45',
                '<a href="javascript:transModal(10, null);">'
                'Budget Transfer - 123.45 from Periodic2 (2) to '
                'Standing2 (5) (10)</a>',
                '<a href="/accounts/1">BankOne</a>',
                '<a href="/budgets/5">Standing2</a>',
    ...
    def test_16_transaction_table(self, base_url, selenium, testdb):
        ...
        assert htmls == self.sort_trans_rows([
            ...
            [
                ppdate.strftime('%Y-%m-%d'),
                '$0.00',
                '<a href="javascript:transModal(9, null);">Skip '
                'ScheduledTransaction 8 in period %s (9)</a>' % (
                    pp.start_date.strftime('%Y-%m-%d')
                ),
                '<a href="/accounts/1">BankOne</a>',
                '<a href="/budgets/1">Periodic1</a>',
