...
- [ ] Code should conform to the following:
    ...
    - [ ] The changelog entry is concise, following the format and level of detail of the
      entries for 1.6.0 and earlier (a sentence or two, plus a few short sub-bullets only
      if needed); background and rationale belong in the pull request description.
