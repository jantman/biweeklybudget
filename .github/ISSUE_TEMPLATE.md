...
How was biweeklybudget installed (provide as much detail as possible, ideally
...
that biweeklybudget is running in, as well as your operating system type and version.

### Actual Output

```
Paste here the output of biweeklybudget (including the command used to run it),
